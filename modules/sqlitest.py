...
log = "modules/vulns/sqli.txt"
logfile = open(log, "a")
lfi_log = "modules/vulns/lfi.txt"
lfi_log_file = open(lfi_log, "a")
rce_log = "modules/vulns/rce.txt"
rce_log_file = open(rce_log, "a")
xss_log = "modules/vulns/xss.txt"
...
xsses = ["<h1>XSS by sechacklabs</h1>","%3Ch1%3EXSS%20by%20sechacklabs%3C/h1%3E"]
